...
<style>
body {
background-image: url("https://www.optimum7.com/wp-content/uploads/2016/01/How-to-Avoid-Plagiarism-and-Learn-the-Right-Way-to-Recycle-an-Article.jpg");
...
input1 =st.text_input('Sentence 1')
input2 =st.text_input('Sentencer 2')
